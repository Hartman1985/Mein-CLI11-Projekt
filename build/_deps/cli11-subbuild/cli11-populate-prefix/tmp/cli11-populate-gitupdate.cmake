...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/CLIUtils/cli11'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/sebastian/repos/Mein-CLI11-Projekt/build/_deps/cli11-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/sebastian/repos/Mein-CLI11-Projekt/build/_deps/cli11-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
